...
import ayyappa.eloksolutions.in.ayyappaap.PadiViewExample;
import ayyappa.eloksolutions.in.ayyappaap.RestServices;


public class FlexiViewHelper {

    private PadiViewExample mcontext;

    public FlexiViewHelper(PadiViewExample mcontext){
