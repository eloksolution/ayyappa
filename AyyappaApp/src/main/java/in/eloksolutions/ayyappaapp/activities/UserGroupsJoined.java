    ...
    setTransferUtility();
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               Intent groupCreate= new Intent(UserGroupsJoined.this, CreateGroup.class);
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.ic_home1:
                        Intent intent1 = new Intent(UserGroupsJoined.this, CardViewActivity.class);
                    ...
                    case R.id.ic_books:
                        Intent intent2 = new Intent(UserGroupsJoined.this, PadiPoojaFull.class);
                        startActivity(intent2);
                        break;

                    case R.id.ic_center_focus:
                        Intent intent3 = new Intent(UserGroupsJoined.this, MapsMarkerActivity.class);
                        startActivity(intent3);
                        break;

                    case R.id.ic_backup:
                        Intent intent4 = new Intent(UserGroupsJoined.this, OwnerView.class);
