...
public class SendAcceptTaskSearch extends AsyncTask<String, Void, String> {
    URL url;
    RegisterDTO registerDto;
    private ProgressDialog progress;
    String gurl;
    SearchSwamiRequest  swamiRequest;
    String tag="SendAcceptTask";

    public SendAcceptTaskSearch(RegisterDTO registerDto, String gurl, SearchSwamiRequest swamiRequest) {
